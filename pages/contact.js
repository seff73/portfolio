            ...
            <div className='w-full my-20 h-auto flex flex-col justify-center items-center'>
                ...
                <div className='md:w-[44.65%] w-[78.8%] flex items-center justify-evenly mt-5'>
                    <div className='md:w-[65%]'>
                        <input
                            ...
                            className='w-full mt-5 pb-1 pl-4 pr-2 border-2 rounded-lg h-10 md:text-base text-base'
                        />
                    </div>
                    <div className='w-full'>
                        <input
                            ...
                            className='w-full mt-5 ml-1 pb-1 pl-4 pr-2 border-2 rounded-lg h-10 md:text-base text-base'
                        />
                    </div>
                </div>
                <div className='flex justify-center text-center md:w-[45%] w-[80%] mt-1'>
                    <input 
                        ...
                        placeholder='Subject'
                        onChange={handleChange}
                        className='mt-1 pb-1 pl-4 pr-2 w-full rounded-lg text-blue-800 md:text-base text-base border-2 border-indigo-900h h-10' 
                    />
                </div>
